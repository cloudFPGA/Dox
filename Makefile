...
clone_local_cfdk_repo:
	git -C '${REPOS}/Dox'           pull || git clone --depth=1 -b master --single-branch git@github.com:cloudFPGA/Dox.git  ${REPOS}/Dox	
...
mv_dox_from_githubcom:
	rsync -arv --exclude=.git --exclude=.gitignore repos_for_Dox/Dox/ ./
